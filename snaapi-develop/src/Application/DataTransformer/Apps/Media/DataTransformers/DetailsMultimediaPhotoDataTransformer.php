...
class DetailsMultimediaPhotoDataTransformer implements MediaDataTransformer
{
    ...
    /**
     * Aspect ratios supported for multimedia photos.
     * Uses centralized ImageSizesRegistry for size definitions.
     */
    private const SUPPORTED_RATIOS = [
        ImageSizesRegistry::ASPECT_RATIO_4_3,
        ImageSizesRegistry::ASPECT_RATIO_16_9,
        ImageSizesRegistry::ASPECT_RATIO_3_4,
        ImageSizesRegistry::ASPECT_RATIO_3_2,
        ImageSizesRegistry::ASPECT_RATIO_2_3,
    ];
    ...
    public function read(): array
    {
        ...
        $allShots = [];
        foreach (self::SUPPORTED_RATIOS as $aspectRatio) {
        ...
        return [
            ...
            'photo' => current($allShots[ImageSizesRegistry::ASPECT_RATIO_16_9]),
        ];
    }
